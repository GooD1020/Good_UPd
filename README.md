...
local Library = Update:Window("sazx ","",Enum.KeyCode.RightControl);
...
Cr:Label("Credit : sazx hub")
Cr:Line()
Cr:Label("DEX : ขอบคุณที่ใช้งาน")
Cr:Line()
Cr:Label("DEX : ขอให้สนุ:)ก")
Cr:Line()
Cr:Button("Copy Link Discord",function()
    setclipboard("https://discord.gg/nyZ5c34KwG")
end)
